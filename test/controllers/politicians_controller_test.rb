...
class PoliticiansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create politician" do
    assert_difference('Politician.count') do
      post politicians_url, params: { politician: { api_id: @politician.api_id, name: @politician.name, party: @politician.party, state: @politician.state } }
    end
  ...
  test "should update politician" do
    patch politician_url(@politician), params: { politician: { api_id: @politician.api_id, name: @politician.name, party: @politician.party, state: @politician.state } }
